...
def main() -> None:
    ...
    command("scripts/run_experiment.py", "--sft", "models/e2e-sft-model", "--dpo", "models/e2e-dpo-model", "--instruct", "models/e2e-dpo-model", "--prompts-dir", "data/tiny/prompts", "--results-dir", "results/e2e", "--min-patching-prompts", "6")
